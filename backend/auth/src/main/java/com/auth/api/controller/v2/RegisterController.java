...
/**
 * Controller responsável pelo registro de novos usuários (V2).
 */
@RestController("registerControllerV2")
@RequiredArgsConstructor
@RequestMapping(value = "/user/register", version = "2")
@Tag(name = "Registro V2", description = "Endpoints para criação de novas contas de usuário")
